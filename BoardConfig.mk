...
BOARD_KERNEL_CMDLINE := bootopt=64S3,32N2,32N2 androidboot.selinux=permissive buildvariant=userdebug enforcing=0 
...
TARGET_PREBUILT_KERNEL := $(LOCAL_PATH)/boot.img
PRODUCT_COPY_FILES += \
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 5918145536
BOARD_FLASH_BLOCK_SIZE := 131072
